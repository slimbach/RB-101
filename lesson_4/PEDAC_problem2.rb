...
# input: string
# output: substring array
# rules: 
#       Explicit requirements: 
#         - return all substrings that are palindromes. (Remember: A palindrome is a word
#           that can be spelled the same forward and backward).
#         - all palindrome words are case sensitive
# 
#       Implicit requirements:
#         - if there are no palindromes, the output is an empty array
#         - if there is no input, the output is an empty array
#         - the substrings should return as new object ids in array
